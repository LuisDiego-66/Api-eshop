...
export class FacturarOrderContingenciaDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'CAFC vigente para la sucursal en el momento del evento',
  ...
  @ApiPropertyOptional({
    description: 'Usuario que emite la factura (por defecto: "admin")',
    example: 'admin',
  })
  @IsOptional()
  @IsString()
